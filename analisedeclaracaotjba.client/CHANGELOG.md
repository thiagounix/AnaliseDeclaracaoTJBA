...
- Create Angular project with ng: `ng new analisedeclaracaotjba.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`analisedeclaracaotjba.client.esproj`).
